        ...
        <div className="mb-2">
             <p className="font-medium">
                ...
                {product.discountRate ? (
                   <>
                     <span className="text-primary font-bold">{discountedMainUnitPrice.toFixed(2)} ر.س</span>
                     <span className="text-xs text-muted-foreground line-through ml-1">{originalMainUnitPrice.toFixed(2)}</span>
                   </>
                ) : (
                    <span className="text-primary font-bold">{originalMainUnitPrice.toFixed(2)} ر.س</span>
                )}
             </p>
                ...
                <p className="font-medium">
                    {product.subUnitType}:{' '}
                     {discountRateNum > 0 ? (
                        ...
                        <span className="text-primary font-bold">{originalSubUnitPrice.toFixed(2)} ر.س</span>
                     )}
                </p>
                <p className="text-xs text-muted-foreground">
